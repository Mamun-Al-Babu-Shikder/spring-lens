...
public final class BeanInstanceInfoCollector implements BeanPostProcessor {
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
        try {
            ...
            logger.debug("Failed to initialized the tracking of bean bean=instance info for beanName '{}' in context '{}'",
                    beanName,
                    this.contextId,
                    ex
            );
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        try {
            ...
            logger.debug("Failed to keep track the bean bean=instance info for beanName '{}' in context '{}'",
                    beanName,
                    this.contextId,
                    ex
            );
