export const UPCOMING = [
    {
        ...
        status: 'Planned',
        statusClass: 'bg-blue-50 text-blue-700 dark:bg-blue-950/50 dark:text-blue-300 border-blue-200 dark:border-blue-800',
    ...
    },
    {
        ...
        status: 'In Design',
        statusClass: 'bg-purple-50 text-purple-700 dark:bg-purple-950/50 dark:text-purple-300 border-purple-200 dark:border-purple-800',
    ...
    },
    {
        ...
        status: 'Planned',
        statusClass: 'bg-amber-50 text-amber-700 dark:bg-amber-950/50 dark:text-amber-300 border-amber-200 dark:border-amber-800',
...
export const RELEASES = [
    {
        ...
        description: 'Comprehensive runtime visibility into your Spring Boot container with zero application code changes. Collects, visualizes, and profiles beans, dependency graphs, conditions, and startup latencies.',
        stats: [
            { label: 'Instrumentation', value: 'Zero Code Changes' },
            { label: 'Target Runtime', value: 'Spring Boot 3.x' },
            { label: 'Diagnostic Engines', value: '5 Live Monitors' }
        ],
        hero: {
            ...
            description: 'Navigate your entire Spring application context through an interactive force-directed canvas. Understand deep bean relationships, detect circular dependencies, and identify core architectural hubs at a glance.',
            icon: 'hub',
            iconColor: '#3b82f6',
            image: 'src/assets/images/whats-new/dependency-graph.png',
            route: 'graph',
            actionText: 'Explore Dependency Graph',
            tags: ['Force Simulation', 'Circular Detection', 'Hub Ranking'],
            highlights: [
        ...
        features: [
            {
                ...
                icon: 'speed',
                iconColor: '#f59e0b',
                image: 'src/assets/images/whats-new/bean-instance.png',
                ...
                tags: ['Gantt Waterfall', 'Threshold Filter', 'Latency Audit'],
                points: [
            ...
            },
            {
                ...
                icon: 'fact_check',
                iconColor: '#2563eb',
                image: 'src/assets/images/whats-new/condition-report.png',
                ...
                tags: ['Condition Audit', 'Why Not Loaded', 'Auto-Config'],
                points: [
            ...
            },
            {
                ...
                icon: 'list_alt',
                iconColor: '#9333ea',
                image: 'src/assets/images/whats-new/bean-definition.png',
                ...
                tags: ['Context Audit', 'Proxy Inspector', 'Scope Matrix'],
                points: [
            ...
            },
            {
                ...
                icon: 'dashboard',
                iconColor: '#10b981',
                image: 'src/assets/images/whats-new/dashboard-overview.png',
                ...
                tags: ['JVM Metrics', 'Environment', 'Radial Tree'],
                points: [
...
export const CATEGORIES = [
    { id: 'all', label: 'All Updates', icon: 'apps' },
    { id: 'Performance', label: 'Performance', icon: 'speed' },
    { id: 'Intelligence', label: 'Intelligence', icon: 'fact_check' },
    { id: 'Discovery', label: 'Discovery', icon: 'list_alt' },
    { id: 'Observability', label: 'Observability', icon: 'dashboard' }
];
